...
INFRA = """## Infrastructure (2026-04-18)
- DarkPhoenix (100.93.183.39) — PRIMARY. CachyOS, RX 6800 XT, Mike's daily driver.
- Berlin VPS (87.106.137.147 / 100.71.89.61) — Relay. Fallback. Internet-facing.
- Portable-dev-machine (100.95.219.37) — Backpack. Development.
- Home-server (100.81.237.29) — Laptop. May be repurposed.
- Chat API: localhost:9802 (DM, group, broadcast)
...
- KAIROS/BG_SESSIONS flags: unblocked for M2.7 (were being stripped)
- Topology shifted 04-16: darkphoenix is home, Berlin is relay only."""
