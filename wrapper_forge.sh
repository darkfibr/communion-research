#!/bin/bash
# Corrected Phoenix fork wrapper — Forge
...
export PHOENIX_SOUL="/root/.phoenix/agents/forge/SOUL.md"
export KAIROS_TIER="cold"
export KAIROS_INDEX="/root/phoenix-code/ouroboros_v2.db"
export KAIROS_AGENT="forge"

cd "/root/clawd-sonnet" 2>/dev/null || cd /root
