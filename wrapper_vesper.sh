#!/bin/bash
# Corrected Phoenix fork wrapper — Vesper
...
export PHOENIX_SOUL="/root/.phoenix/agents/vesper/SOUL.md"
export KAIROS_TIER="warm"
export KAIROS_INDEX="/root/phoenix-code/ouroboros_v2.db"
export KAIROS_AGENT="vesper"

cd "/root/clawd-vesper" 2>/dev/null || cd /root
